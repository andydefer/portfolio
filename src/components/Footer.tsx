      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          >
            ...
            >
              ...
              digital experiences that are fast, accessible, and responsive.
            </motion.p>
            <motion.p
        ...
        >
          <motion.p
            ...
            animate={isFooterInView ? { y: 0, opacity: 1 } : { y: 20, opacity: 0 }}
          ...
          >
            ...
            <motion.span
              ...
              animate={isFooterInView ? { scale: 1, opacity: 1 } : { scale: 0.5, opacity: 0 }}
              transition={{
                type: "spring",
                stiffness: 500,
                damping: 15,

...
import { fadeInLeft, fadeInRight, fadeInUp, staggerContainer, popIn } from '../utils/animations';
...
const Contact = () => {
  ...
  const isContactInfoInView = useScrollAnimation(contactInfoRef, { threshold: 0.2 });
  const isContactFormInView = useScrollAnimation(contactFormRef, { threshold: 0.2 });
          ...
          >
            ...
            >
              ...
              <motion.button
                ...
                variants={popIn}
                whileHover={!isSubmitting ? { scale: 1.03, boxShadow: "0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05)" } : {}}
